...
public class CredentialProviderTestBase {
  ...
  public static void beforeClass() throws CredentialProvisioningException, IOException,
    ...
    when(mockCredentialProvider.provision(any(), any(), any(), any())).thenReturn(RETURNED_TOKEN);
    CredentialProvider validationFailureMockCredentialProvider = mock(CredentialProvider.class);
    when(validationFailureMockCredentialProvider.provision(any(), any(), any(), any()))
    ...
    when(provisionFailureMockCredentialProvider.provision(any(), any(), any(), any()))
