...
public class PluginInfo extends PluginSummary {
  ...
  public PluginInfo(String name, String type, String category, String className, List<String> classNames,
                    @Nullable String configFieldName, ArtifactSummary artifact,
                    Map<String, PluginPropertyField> properties, String description) {
    super(name, type, category, className, classNames, artifact, description);
  ...
  public String toString() {
    return "PluginInfo{" +
      ...
      ", classNames=" + getRuntimeClassNames() +
